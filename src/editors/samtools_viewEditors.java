...
public class samtools_viewEditors extends javax.swing.JDialog implements EditorInterface {

    /**
     * Creates new form samtools_viewEditors
     */
    ...
    public samtools_viewEditors(java.awt.Frame parent, armadillo_workflow parent_workflow){
        super(parent, false);
    ...
    private void initComponents() {
        ...
        samtools_view_tab.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentShown(java.awt.event.ComponentEvent evt) {
                samtools_view_tab_ComponentShown(evt);
            }
        });
        ...
        AO_jPanelLayout.setHorizontalGroup(
            ...
            .addComponent(AO_AO1_H_box)
            .addComponent(AO_AO1_1_box)
            .addComponent(AO_AO1_b_box)
            .addComponent(AO_AO1_S_box)
        );
    ...
    private void samtools_view_tab_ComponentShown(java.awt.event.ComponentEvent evt){//GEN-FIRST:event_samtools_view_tab_ComponentShown
        // TODO add your handling code here:
    }//GEN-LAST:event_samtools_view_tab_ComponentShown
    ...
    private void AO_AO1_h_box_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AO_AO1_h_box_ActionPerformed
        // TODO add your handling code here:
        if (
            properties.isSet(AO_AO1_H_box.getName())
        ){
            properties.remove(AO_AO1_H_box.getName());
            AO_AO1_H_box.setSelected(false);
        }
    ...
    private void AO_AO1_1_box_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AO_AO1_1_box_ActionPerformed
        // TODO add your handling code here:
        Util.boxEventSpinner(properties,AO_AO1_1_box,null);
    }//GEN-LAST:event_AO_AO1_1_box_ActionPerformed
    private void AO_AO1_b_box_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AO_AO1_b_box_ActionPerformed
        ...
        if (properties.isSet(AO_AO1_b_box.getName())) {
            AO_AO1_1_box.setEnabled(true);
        } else {
            AO_AO1_1_box.setEnabled(false);
            AO_AO1_1_box.setSelected(false);
            properties.remove(AO_AO1_1_box.getName());
        }

    }//GEN-LAST:event_AO_AO1_b_box_ActionPerformed
    private void AO_AO1_S_box_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AO_AO1_S_box_ActionPerformed
        // TODO add your handling code here:
    ...
    public void perpareDictionaries(workflow_properties properties){
        ...
        DictMenuCBS0.put(AO_AO1_H_box,null);
        DictMenuCBS0.put(AO_AO1_1_box,null);
        DictMenuCBS0.put(AO_AO1_b_box,null);
        DictMenuCBS0.put(AO_AO1_S_box,null);
    }
    ...
    private javax.swing.JCheckBox AO_AO1_1_box;
    private javax.swing.JCheckBox AO_AO1_H_box;
    private javax.swing.JLabel AO_AO1_JLabel;
    private javax.swing.JCheckBox AO_AO1_S_box;
    ...
    private javax.swing.JTabbedPane samtools_view_tab;
